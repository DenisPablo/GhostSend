...
public class UploadFileCommandHandlerTests
{
    ...
    public async Task UploadFileCommandHandler()
    {
        ...
        storageMock.Setup(x => x.UploadFileAsync(It.IsAny<Stream>(), It.IsAny<string>(), It.IsAny<string>(), It.IsAny<CancellationToken>()))
        ...
        storageMock.Verify(x => x.UploadFileAsync(It.IsAny<Stream>(), It.IsAny<string>(), It.IsAny<string>(), It.IsAny<CancellationToken>()), Times.Once);
    ...
    public async Task UploadFileCommandHandler_WhenFileExceedsMaxSize()
    {
        ...
        storageMock.Verify(x => x.UploadFileAsync(It.IsAny<Stream>(), It.IsAny<string>(), It.IsAny<string>(), It.IsAny<CancellationToken>()), Times.Never);
